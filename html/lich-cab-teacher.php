...
?>
  ...
  <body>
   ...
   <button class="back"> <a href="./lich-cab.php"><img src="../img/back@2x.png" alt=""></a> </button>
    <!-- Автоизация -->
    <form class="block-autoriz" action="../dataBase/auth-teacher.php" method="post" enctype="multipart/form-data">
      <h1>Авторизация</h1>
      <!-- логин -->
